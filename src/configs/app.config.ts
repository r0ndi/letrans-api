...
const appConfig = {
    ...
    DEFAULT_TRANSLATOR_PROVIDER: String(process.env.DEFAULT_TRANSLATOR_PROVIDER),
    GOOGLE_APPLICATION_CREDENTIALS: String(process.env.GOOGLE_APPLICATION_CREDENTIALS || ""),
    RAPIDAPI_KEY: String(process.env.RAPIDAPI_KEY || ""),
};
